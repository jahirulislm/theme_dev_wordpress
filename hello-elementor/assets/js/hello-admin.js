/******/ (() => {
  ...
  \****************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var _settingsPanel = __webpack_require__(
          /*! ./../panels/settings-panel.js */ "./assets/dev/js/admin/panels/settings-panel.js"
        );
        const Notices = () => {
          ...
          (0, _react.useEffect)(() => {
            const fetchSettings = async () => {
              try {
                ...
                Object.values(SETTINGS).forEach(
                  (value) =>
                    (data[value] = response[`${settingsPrefix}${value}`])
                );
        ...
        const SettingsPanel = ({ SETTINGS, settingsData, updateSettings }) => {
          ...
          return /*#__PURE__*/ React.createElement(
            ...
            /*#__PURE__*/ React.createElement(
              ...
              ' <header class="page-header"> <h1 class="entry-title"> Post title </h1> </header> '
            ),
            /*#__PURE__*/ React.createElement(_components.ToggleControl, {
              label: (0, _i18n.__)(
  ...
  \********************************************/
    ...
    __webpack_require__(
      /*! ./hello-admin.scss */ "./assets/dev/js/admin/hello-admin.scss"
    );
    var _element = __webpack_require__(
      /*! @wordpress/element */ "@wordpress/element"
    );
    var _settingsPage = __webpack_require__(
      /*! ./pages/settings-page.js */ "./assets/dev/js/admin/pages/settings-page.js"
    );
    const App = () => {
      return /*#__PURE__*/ React.createElement(
